...
from ModuleR_patch_corss_test import *
import torch
...
class GPTReDo(pl.LightningModule): 
    ...
    def __init__(self, config_GPT, config_others):
        ...
        self.transformer = nn.ModuleDict(dict(
            ...
            wpe = nn.Embedding(config_GPT.block_size, config_GPT.n_embd),
        ...
        self.cross_decoder = TransformerDecoder(self.config_GPT.n_embd, self.config_GPT.n_head, self.config_GPT.n_embd * 2, 0,self.config_GPT.n_layer )
    ...
    def forward(self, idx, targets=None):
        ...
        #x_patched
        predict = self.cross_decoder(predict, x_patched)
    ...
    def training_step(self, batch, batch_idx):
        ...
        pred_logits, loss = self.forward(train_data, target)
        assert loss != None
